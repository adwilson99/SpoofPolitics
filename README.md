...
- **Theme music** ("Cobblestone Overture", `frontend/audio/theme.mp3`): generated with [Suno](https://suno.com) under a paid plan — commercial-use rights held by the repository owner.
